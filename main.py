...
def remove_temp_image(path):
    ...
    try:
        ...
        print(
            f"⚠ Could not remove temporary image: {e}",
            flush=True
        )
...
def find_main_publish_button(page):
    ...
    selectors = [
        ...
        '[role="button"]:has-text("প্রকাশ করুন")'
    ]
    ...
    try:
        ...
        if modal is None:
            ...
            try:
                ...
                with open(
                    "serey_debug_publish_modal.html",
                    "w",
                    encoding="utf-8"
                ) as f:
