...
def get_posts():
    ...
    while len(posts) < 5000:
        ...
        for p in batch:
            ...
            # ------------------------------------------------
            # STOP WHEN POST IS OLDER THAN 30 DAYS
            # ------------------------------------------------
...
def verify(
    ...
    for _ in range(5):
        ...
        # ----------------------------------------------------
        # EXPECTED PUBLISHED POST URL
        #
        # Example:
        # https://serey.io/authors/mamun/8s6x4vp1zn...
        # ----------------------------------------------------
        ...
        try:
            ...
            for i in range(
                ...
                # Relative Serey author post URL
